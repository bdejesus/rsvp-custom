 ...
 */
/*
Plugin Name: RSVP_JUCY
Text Domain: rsvp-plugin
Plugin URI: http://wordpress.org/extend/plugins/rsvp/
Description: Customized for the JUCY2015 Wedding. This plugin allows guests to RSVP to an event.  It was made initially for weddings but could be used for other things.
Author: MDE Development, LLC
Version: 2.0.7
	...
	function rsvp_admin_import() {
      ...
      if($data->sheets[0]['numCols'] >= 6) {
        ...
        $i = ($skipFirstRow) ? 2 : 1;
          ...
          $numberOfGuests = (isset($data->sheets[0]['cells'][$i][5])) ?  $numberOfGuests = $data->sheets[0]['cells'][$i][5] : 0;

          $personalGreeting = (isset($data->sheets[0]['cells'][$i][6])) ? $personalGreeting = $data->sheets[0]['cells'][$i][5] : "";
          $passcode = (isset($data->sheets[0]['cells'][$i][7])) ? $data->sheets[0]['cells'][$i][7] : "";
